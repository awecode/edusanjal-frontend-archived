<template>
    ...
    <!--&lt;!&ndash;<a v-for="(image, index) in obj.images" :href="image.url.full" :key="image.name+index">&ndash;&gt;-->
    <!--&lt;!&ndash;<img :data-bp="image.url.full" :src="image.url.small" :title="image.name" :alt="image.name">&ndash;&gt;-->
    <!--&lt;!&ndash;</a>&ndash;&gt;-->
    <!--</div>-->
    <!--</div>-->
    <!--</div>-->
